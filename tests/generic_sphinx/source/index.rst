Welcome to sphinx-docbook-test's documentation!
===============================================
...
The ``_static/biohazard.png`` part indicates the filename of the image
...
reStructuredText Markup Specification is the place to go.
